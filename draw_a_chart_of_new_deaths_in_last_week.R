...
my_plot <- for_new_deaths_in_last_week_chart %>% draw_a_jburnish_chart(
  x = DaysSinceMinNewDeathsInLastWeek, y = NewDeathsInLastWeek, group = Country, y_min = min_new_deaths_in_last_week, y_max = 2000,
...
scaling_factor <- 1.56
ggsave(
  paste0("output/", pretty_max_date, " New Deaths in Last Week", ".png"),
